...
// const filters = /\b(?:mental|health|mood|unhappy|depress*|therap*|help|counsel*|trauma|psych*|anxiety|anxious|disorder|diagnosis)\b/i
...
function call_GPT3(msg) {
    var answer = eliza.transform(msg);
    fakeMessage(answer);
